		...
		<ul class="row">
		  ...
		  <?php 
			   ...
			   $last_line = "";
						...
						?>
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?> <?php if ($product['special']) { ?>saleBox<?php } ?>">
				<div class="image2">
					<?php if ($product['thumb']) { ?><a href="<?php echo $product['../My Documents/Downloads/47094_tg_eva_Pv5De4Ej6Ph5/theme299/theme299((full))/catalog/view/theme/theme299/template/module/href']; ?>"><img id="img_<?php echo $product['product_id']; ?>" src="<?php echo $product['../My Documents/Downloads/47094_tg_eva_Pv5De4Ej6Ph5/theme299/theme299((full))/catalog/view/theme/theme299/template/module/thumb']; ?>" alt="<?php echo $product['name'];?>" /></a><?php } ?>
					
				</div>
				<div class="inner">
					<div class="f-left">
						<div class="name maxheight-best"><a href="<?php echo $product['../My Documents/Downloads/47094_tg_eva_Pv5De4Ej6Ph5/theme299/theme299((full))/catalog/view/theme/theme299/template/module/href']; ?>"><?php echo $product['name']; ?></a></div>
					...
					<div class="rating">
						<?php if ($product['rating']) { ?>
							<img height="13" src="catalog/view/theme/theme299/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
						<?php } ?>
					</div>
				</div>
				<div class="clear"></div>
