...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
	...
	<div class="span6">
	  ...
	  <div class="cart">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme299/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
  ...
  <?php if ($products) { ?>
  <h1 class="style-2 mt0"><?php echo $tab_related;?></h1>
  <div  class="related">
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<div class="cart-button">
				<div class="cart">
					<a title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button button-i">
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme299/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme299/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
