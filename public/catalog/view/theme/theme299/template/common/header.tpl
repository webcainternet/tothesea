...
<link href='http://fonts.googleapis.com/css?family=Roboto:400,100,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css' />
...
$.src='//v2.zopim.com/?2ljvBwcfbBcr5rs6djFYa2mR2DRU0qmD';z.t=+new Date;$.
		...
		<div class="row">
			<div class="span12">
                ...
                <div class="logChek">
                    ...
                    <?php } ?>
                    <li class="check"><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="checkout/checkout") {echo "active";} ?>" href="<?php echo $checkout; ?>"><i class="icon-check"></i><?php echo $text_checkout; ?></a></li>
                    </ul>
                </div>
				<div id="search">
					<div class="inner">
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme299/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
